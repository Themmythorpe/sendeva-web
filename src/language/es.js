export const spain = {
  ...
  "Register as seller and open shop in SendEva to start your business":
    "سجل كبائع وافتح متجرًا في SendEva لبدء عملك",
  ...
  Solution: "حل",
  "SendEva is a one-stop shop for all your daily necessities. You can shop for groceries, and pharmacy items, order food, and send important parcels from one place to another from the comfort of your home.":
    "SendEva عبارة عن نظام متعدد البائعين للأغذية والبقالة والتجارة الإلكترونية والطرود والصيدليات قائم على Laravel و Flutter Framework. يحتوي على ست وحدات لتغطية جميع وظائف عملك.",
